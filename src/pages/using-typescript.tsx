...
const UsingTypescript: React.FC<PageProps<DataProps>> = ({ data, path }) => (
  <Layout>
    ...
    <p>
      ...
      etc. Please note that the <em>gatsby-*.js</em> files (like gatsby-node.js) currently dont
      support TypeScript yet.
    </p>
    <p>
      For type checking youll want to install <em>typescript</em> via npm and run{" "}
      <em>tsc --init</em> to create a <em>.tsconfig</em> file.
    </p>
    <p>
      Youre currently on the page {path} which was built on {data.site.buildTime}.
    </p>
    <p>
